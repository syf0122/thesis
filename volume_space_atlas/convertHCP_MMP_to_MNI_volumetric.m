...
for resl=0:reslice
    if resl==1
        % resample image to 4 4 4 mm space
        ea_reslice_nii('mni_icbm152_gm_tal_nlin_asym_09a.nii','mni_icbm152_gm_tal_nlin_asym_09a_4.nii',[4 4 4]);
        nii=spm_vol('mni_icbm152_gm_tal_nlin_asym_09a_4.nii');
        suffx='_4mm';
    else
