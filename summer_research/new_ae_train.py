    ...
    for subject in subjects:
        ...
        for f in processed_files:
            if session in f and "_p.npy" in f:
                mtx_p = np.load(sub_dir+f)[:, :-19] # (900, 379)
...
def train_360(train_data, epo, name):
    ...
    # saving whole model
    autoencoder.save('/data_qnap/yifeis/NAS/ae_updated/model_hcp/autoencoder_360.hdf5')
    encoder.save('/data_qnap/yifeis/NAS/ae_updated/model_hcp/encoder_360.hdf5')
    decoder.save('/data_qnap/yifeis/NAS/ae_updated/model_hcp/decoder_360.hdf5')
...
def train_379(train_data, epo, name):
    ...
    # saving whole model
    autoencoder.save('/data_qnap/yifeis/NAS/ae_updated/model_hcp/autoencoder_379.hdf5')
    encoder.save('/data_qnap/yifeis/NAS/ae_updated/model_hcp/encoder_379.hdf5')
    decoder.save('/data_qnap/yifeis/NAS/ae_updated/model_hcp/decoder_379.hdf5')
...
plt.savefig('/data_qnap/yifeis/NAS/ae_updated/model_hcp/train_360_MSE.png')
plt.clf()
...
plt.savefig('/data_qnap/yifeis/NAS/ae_updated/model_hcp/train_379_MSE.png')
plt.clf()
