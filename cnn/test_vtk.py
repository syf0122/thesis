...
model_path = "/data_qnap/yifeis/spherical_cnn/models/epo_5/Unet_160k_test_"+str(sub_train)+'_'+hemi+"_final.pkl"
...
if type_fmri == 'movie':
    ...
    sessions = ['rest1', 'rest2', 'rest3', 'rest4']
elif type_fmri == 'ret':
    sessions = ['retbar1', 'retbar2', 'retccw', 'retcon', 'retcw', 'retexp']
else:
    print('Invalid type!')
    quit()

print(f'Test Sessions: {sessions}')
